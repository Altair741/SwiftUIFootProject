            ...
            .sheet(isPresented: $sendMail) {
                if MFMailComposeViewController.canSendMail() {
                    EmailSender(
                        ...
                        messageBody:"""
                            The Assessment has done on the date of \(answer.currentDate) at \(currentLocation) and it took \(Int(answer.assessmentTime)), and patient risk level generated by system is \(answer.system_g_risk)
