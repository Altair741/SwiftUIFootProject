...
struct RiskCalculator_system: View {
...
//    @State private var allFinished : Bool
    ...
    var body: some View {
        ...
        if isActive
        {
            ...
            {
                Alert(
                    title: Text("Assessment not fully completed"),
...
//        print("Risck Calculator showed up and call checkAlert method")
//        print(showAlert)
    }
...
struct RiskCalculator: View {
    ...
    var body: some View {
        ZStack{
            ...
            VStack {
                ...
                VStack {
                    NavigationLink(destination: RiskCalculator_system().navigationBarBackButtonHidden()) {
                        Text("Very Low")
                            .padding()
                            .frame(width: 200, height: 50)
    ...
    //            if showAlert
    //            {
    //                AlertPopup(allquestionAnswered: false).zIndex(1)// order in Zstack
    //            }
    //
    //            VStack {
    //
    ...
    //    }
    //    func checkAlert() {
    //            showAlert = !answer.checkCompletion()
    //            print("Risk Calculator showed up and call checkAlert method")
    //            print(showAlert)
    //        }
    //}
